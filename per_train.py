...
data_conversion = Data_conversion(train_data,tokenizer,["text"],None,None,None,512,True)
...
trainer = L.Trainer(devices="auto",
                    ...
                    max_steps=int((13000000//(train_loader.batch_size*32))*2),
                    overfit_batches=0,
                    callbacks=[
